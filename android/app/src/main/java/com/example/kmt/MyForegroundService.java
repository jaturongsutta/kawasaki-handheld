    ...
    private void registerWithServer() {
        new Thread(() -> {
            try {
                ...
                // URL url = new URL("http://192.168.1.15:83/api/alert/register-device"); //customer dev
                URL url = new URL("http://192.168.1.15:83/api/alert/register-device"); //customer prod
