...
part 'line_stop_production_model.g.dart';

@JsonSerializable()
class LineStopProductionPlanModel {
  ...
  factory LineStopProductionPlanModel.fromJson(Map<String, dynamic> json) =>
      _$LineStopProductionPlanModelFromJson(json);

  Map<String, dynamic> toJson() => _$LineStopProductionPlanModelToJson(this);
}
