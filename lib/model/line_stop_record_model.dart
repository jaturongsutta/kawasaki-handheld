...
part 'line_stop_record_model.g.dart';

@JsonSerializable()
class LineStopRecordModel {
  ...
  factory LineStopRecordModel.fromJson(Map<String, dynamic> json) =>
      _$LineStopRecordModelFromJson(json);

  Map<String, dynamic> toJson() => _$LineStopRecordModelToJson(this);
}
