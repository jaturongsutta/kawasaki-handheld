...
ProductionPlanModel _$ProductionPlanModelFromJson(Map<String, dynamic> json) =>
    ProductionPlanModel(
      ...
      planFgAmt: (json['plan_fg_amt'] as num?)?.toInt() ?? 0,
      actualFgAmt: (json['actual_fg_amt'] as num?)?.toInt() ?? 0,
      ngAmt: (json['NG_Amt'] as num?)?.toInt() ?? 0,
      status: json['status'] as String? ?? '',
      id: (json['id'] as num?)?.toInt() ?? 0,
      planDt: json['plan_dt'] as String?,
      lineName: json['Line_Name'] as String?,
      otValue: json['OT_Value'] as String?,
    );

Map<String, dynamic> _$ProductionPlanModelToJson(
        ProductionPlanModel instance) =>
    <String, dynamic>{
