...
part of 'ng_historical_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

HistoricalRecordModel _$HistoricalRecordModelFromJson(
    ...
    HistoricalRecordModel(
      ...
      ngDate: json['NG_Date'] as String,
      ngTime: json['NG_Time'] as String,
...
Map<String, dynamic> _$HistoricalRecordModelToJson(
        HistoricalRecordModel instance) =>
    <String, dynamic>{
      ...
      'NG_Date': instance.ngDate,
      'NG_Time': instance.ngTime,
